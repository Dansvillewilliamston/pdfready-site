...
**To:** Find via https://accessibility.osu.edu/ (they have an active ADA Title II page)  
...
## Email 5 — Small City/County Government (template — customize)

**To:** IT Director or City Clerk at any city/county government with a public website  
**Find targets:** Search "[city name] city government PDF documents" — if they have PDFs on their website, they need this service  
**Subject:** PDF accessibility compliance for [City Name] — free first document

Hi [Name / "IT Team"],

I run PDFReady, a service that remediates government PDFs to WCAG 2.1 AA and PDF/UA-1 compliance for ADA Title II. Every job includes a passing veraPDF validation report — the machine-verifiable proof that holds up in any audit or complaint response.
